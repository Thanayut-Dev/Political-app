...
class SlidNewsBar extends StatefulWidget {
  SlidNewsBar({Key key}) : super(key: key);

  @override
  _SlidNewsBarState createState() => _SlidNewsBarState();
}

class _SlidNewsBarState extends State<SlidNewsBar> {
